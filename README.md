...
An end to end machine learning project designed to classify SMS messages as either "spam" or "ham" (legitimate). This repository contains a comprehensive Jupyter Notebook that processes natural language data, balances class distributions, and provides a deep dive into the performance differences between standard non-ensemble algorithms and advanced ensemble techniques.
...
A. Non-Ensemble (Base) Models
These models serve as our baseline and provide fast, interpretable classification:
...
B. Ensemble Models
These models combine multiple weak learners to create a stronger, more generalized predictive model. We applied hyperparameter tuning (GridSearchCV) to optimize their performance:
...
7.  Clone the repository:
    git clone [https://github.com/yourusername/sms-spam-ensemble-vs-base.git](https://www.google.com/search?q=https://github.com/yourusername/sms-spam-ensemble-vs-base.git)
    cd sms-spam-ensemble-vs-base
